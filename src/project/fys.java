 ...
 * @author Admin
 */
public class fys extends javax.swing.JFrame {

    /**
     * Creates new form fys
     */
    public fys() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fys.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
