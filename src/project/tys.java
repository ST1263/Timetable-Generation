 ...
 * @author Admin
 */
public class tys extends javax.swing.JFrame {

    /**
     * Creates new form tys
     */
    public tys() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tys.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
